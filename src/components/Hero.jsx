    ...
    return (
        ...
        >
            <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-10 md:pt-20 ">
                ...
                <h1 className=" font-palanquin text-6xl max-sm:text-[55px] max-sm:leading-[60px] font-bold z-1 max-lg:z-0 leading-12 ">
                    <span className=" text-white relative z-10 pr-10 rounded-full text-5xl ">
                        ...
                        <span className='text-slate-600'>Empower Your
            ...
            <div className=" relative flex-1 flex justify-center items-center   ">
                <button className='bg-white bg-opacity-40 px-2 py-1 font-bold rounded-full top-[300px] absolute left-[50px]  z-30 '
                    onClick={() => {
                ...
                />
                <button className='bg-white bg-opacity-40 absolute px-2 py-1 font-bold rounded-full right-[50px] top-[300px]  z-30 '
                    onClick={() => {
